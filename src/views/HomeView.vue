<template>
  <div class="wrapper">
    ...
    <DTag
      v-for="(item, index) in tags" :key="index" :theme="item.theme" :color="item.color" closable :type="item.type"
      @handle-close="tagClose">
      {{ item.label }}
    </DTag>
    ...
    <div>
      <DSelect
        v-model="selectValueMut" multiple label="多选：" clearable :data="selectData" @handle-clear="selectClear"
